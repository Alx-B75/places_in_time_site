    ...
    <div className="app-shell">
      ...
      <footer className="site-footer">
        <div className="content-container footer-grid">
          ...
          <div>
            <p className="eyebrow">About & News</p>
            <p>
              <a
          ...
          <div>
            ...
            <p>
              <a
                href="https://places-in-time.com/privacy-policy-gdpr/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Privacy & GDPR
            ...
            <p>
              <a
                href="https://places-in-time.com/terms-of-use/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Terms of Use
            ...
            <p>
              <a
                href="https://places-in-time.com/impressum/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Impressum
